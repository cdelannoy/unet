...
def trainGenerator(batch_size,train_path,image_folder,mask_folder,aug_dict,image_color_mode = "rgb", #image_color_mode = "grayscale",
...
def testGenerator(test_path,num_image = 30,target_size = (160,160),flag_multi_class = False,as_gray = True):
    for i in range(num_image):
        img = io.imread(os.path.join(test_path,"%d.TIF"%i),as_gray = as_gray, plugin = 'tifffile')
        img = img / 159
